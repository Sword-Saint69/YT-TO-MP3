...
def main():
    ...
    tk.Button(input_frame, text="Preview", font=("Arial", 10), command=lambda: show_video_preview(extract_video_id(url_or_id.get()))).grid(row=0, column=2, padx=5, pady=5)
    ...
    tk.Button(output_frame, text="Browse", font=("Arial", 10), command=lambda: output_dir.set(filedialog.askdirectory())).grid(row=0, column=2, padx=5, pady=5)
    ...
    title_label = tk.Label(preview_frame, text="Title: N/A", font=("Arial", 12), bg="#f0f0f0")
    ...
    speed_label = tk.Label(root, text="Speed: 0 KB/s", font=("Arial", 12), bg="#f0f0f0")
    speed_label.pack(pady=5)

    # Queue Label
    queue_label = tk.Label(root, text="Queue: 0 items", font=("Arial", 12), bg="#f0f0f0")
    ...
    tk.Button(button_frame, text="Add to Queue", font=("Arial", 12), command=lambda: add_to_queue(url_or_id.get())).grid(row=0, column=0, padx=10)
    tk.Button(button_frame, text="Start Queue", font=("Arial", 12), command=lambda: threading.Thread(target=process_queue).start()).grid(row=0, column=1, padx=10)
    pause_button = tk.Button(button_frame, text="Pause", font=("Arial", 12), command=toggle_pause)
    pause_button.grid(row=0, column=2, padx=10)
    tk.Button(button_frame, text="Toggle Theme", font=("Arial", 12), command=toggle_theme).grid(row=0, column=3, padx=10)
